...
``` r
#every time you run this, you get a different value because each time you are running it you are generating a different sample and that new sample has a different sample mean
...
sim_result_df =
  ...
  mutate(estimate_df = map(sample_size, sim_mean_sd)) |> #mutate allows you to add a column with the sample size and mean and sd for reach iteration
  unnest(estimate_df)
...
<img src="simulations_files/figure-gfm/unnamed-chunk-11-2.png" width="90%" />
